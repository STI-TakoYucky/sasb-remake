  ...
  return (
    <main className="flex justify-center items-center h-screen bg-primary-200">
      <section className="shadow-2xl w-full global-mx flex flex-col justify-center items-center rounded-md bg-white h-[35rem] p-8 max-w-[30rem]">
        ...
        <form className="form-control gap-5 w-full">
          ...
          <input className="btn btn-success my-5" type="submit" value="Log In"></input>
        </form>
        ...
        <div>
          <p>Need an account? <Link href={""} className="underline text-primary-200">Register</Link></p>
        </div>
      </section>
    </main>
  );
